...
instance ToJSON PollData where
  toJSON = genericToJSON defaultOptions {
    fieldLabelModifier = camelTo2 '_' . drop 9 }
...
data RequestOptions = 
  GetUpdates {
    updates_offset :: Maybe Integer,
    updates_limit :: Maybe Integer,
    updates_timeout :: Maybe Integer,
    updates_allowedUpdates :: Maybe [Text] -- specify [“message”, “edited_channel_post”, “callback_query”]
  } | 
  SendMessage {
    sendMes_chatId :: Integer,
    sendMes_text :: Text,
    sendMes_disableNotification :: Maybe Bool,
    sendMes_replyToMessageId :: Maybe Integer
  } |
  QueryMessage {
    sendQue_chatId :: Integer,
    sendQue_text :: Text,
    sendQue_disableNotification :: Maybe Bool,
    sendQue_replyToMessageId :: Maybe Integer,
    sendQue_replyMarkup :: Maybe InlineKeyboardMarkup
  } |
  CopyMessage {
    copwMes_chatId :: Integer,
    copwMes_fromChatId :: Integer,
    copwMes_messageId :: Integer
  } |
  GetBotCommands {
