...
genStickerAttach =
  VkAttach.AttachSticker
    <$> genSticker

genWallReplyAttach :: Gen VkAttach.Attachment
genWallReplyAttach =
  VkAttach.AttachWallReply
    <$> genWallReply
...
genMarketAlbumAttach =
  VkAttach.AttachMarketAlbum
    <$> genMarketAlbum

genMarketAttach :: Gen VkAttach.Attachment
genMarketAttach =
  VkAttach.AttachMarket
    <$> genMarket
